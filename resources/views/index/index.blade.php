       ...
       <tbody> 
        <tr> 
         ...
         <td> 
          ...
          </div> <span class="sr-only">73%</span> </td> 
        </tr> 
        <tr> 
         ...
         <td> 
          ...
          </div> <span class="sr-only">57%</span> </td> 
        </tr> 
        <tr> 
         ...
         <td> 
          ...
          </div> <span class="sr-only">93%</span> </td> 
        </tr> 
        <tr> 
         <td><img src="img/India.png" style="height:18px; margin-top:-2px;" /></td> 
         <td>Russia</td> 
         ...
         <td> 
          ...
          </div> <span class="sr-only">20%</span> </td> 
        </tr> 
        <tr> 
         <td><img src="img/Spain.png" style="height:18px; margin-top:-2px;" /></td> 
         <td>USA</td> 
       ...
       <ul class="chats"> 
        ...
        <li class="by-me"> 
         ...
         <div class="chat-content"> 
          ...
          </div> Vivamus diam elit diam, consectetur dapibus adipiscing elit. 
          <div class="clearfix"></div> 
         </div> </li> 
        ...
        <li class="by-other"> 
         ...
         <div class="chat-content"> 
          ...
          </div> Vivamus diam elit diam, consectetur fconsectetur dapibus adipiscing elit. 
          <div class="clearfix"></div> 
         </div> </li> 
        <li class="by-me"> 
         <div class="avatar pull-left"> 
    ...
    <section class="panel"> 
     <div class="panel-body progress-panel"> 
      <div class="row"> 
       ...
       <div class="col-lg-4"> 
        <span class="profile-ava pull-right"> <img alt="" class="simple" src="img/avatar1_small.jpg" /> Jenifer smith </span> 
       </div> 
      </div> 
     </div> 
       ...
       <div class="form quick-post"> 
        ...
        <form class="form-horizontal"> 
         ...
         <div class="form-group"> 
          ...
          <div class="col-lg-10"> 
           <select class="form-control"> <option value="">- Choose Cateogry -</option> <option value="1">General</option> <option value="2">News</option> <option value="3">Media</option> <option value="4">Funny</option> </select> 
          </div> 
         </div> 
         <!-- Tags --> 
         <div class="form-group"> 
